...
class DesktopContainer extends Component {
 ...
 onClickedPatient = async event => {
  ...
  const accounts = await web3.eth.getAccounts(); // This line gets the accounts
  Router.pushRoute(`/record/${accounts[0]}`); // If accounts is empty, accounts[0] is undefined
}
...
class MobileContainer extends Component {
 ...
 onClickedPatient = async event => {
  event.preventDefault();
  try {
    // This ensures MetaMask is actually connected and permissions are granted
